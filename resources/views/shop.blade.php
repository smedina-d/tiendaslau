    ...
    <header id="header">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                ============================================= -->
                <div id="logo">
                    <a href="index.html" class="standard-logo" data-dark-logo="images/logo-dark.png"><img src="images/lauLogo.png" alt="Canvas Logo"></a>
        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <div class="col_one_third col_last">
                    ...
                    <a href="#" class="social-icon si-paypal" data-toggle="tooltip" data-placement="top" title="Aceptamos PayPal">
                        <i class="icon-paypal"></i>
                        <i class="icon-paypal"></i>
                    </a>

                    <a href="#" class="social-icon si-googleplay" data-toggle="tooltip" data-placement="top" title=" Descarga nuestra App">
                    ...
                    -->
                    <a href="#" class="social-icon si-email3" data-toggle="tooltip" data-placement="top" title="Correo Electrónico">
