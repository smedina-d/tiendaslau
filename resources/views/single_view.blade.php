                                    ...
                                    <div class="fslider" data-pagi="false" data-arrows="false" data-thumbs="true">
                                        <div class="flexslider">
                                            <div class="slider-wrap" data-lightbox="gallery">
                                                <div class="slide" data-thumb="{{ asset('des/thumbProducto.png') }}"><a
                                                        href="#!" title="Pink Printed Dress - Front View"
                                                        data-lightbox="gallery-item"><img
                                                            src="{{ asset('des/ImagenDesarrolloProductosLau.png') }}"
                                                            alt="Pink Printed Dress"></a></div>
                                                <div class="slide" data-thumb="{{ asset('des/thumbProducto2.png') }}"><a
                                                        href="#!" title="Pink Printed Dress - Side View"
                                                        data-lightbox="gallery-item"><img
                                                            src="{{ asset('des/ImagenDesarrolloProductosLau2.png') }}"
                                                            alt="Pink Printed Dress"></a></div>
                                                <div class="slide" data-thumb="{{ asset('des/thumbProducto3.png') }}"><a
                                                        href="#!" title="Pink Printed Dress - Back View"
                                                        data-lightbox="gallery-item"><img
                                                            src="{{ asset('des/ImagenDesarrolloProductosLau3.png') }}"
                                                            alt="Pink Printed Dress"></a></div>
                                            </div>
                                        </div>
                                    </div>
